...
const Pagination: React.FC<{ count: number }> = ({ count }) => {
  ...
  return (
    <StyledPagination>
      ...
      <Buttons>
        <PaginationButton hide={currentPage === 1} onClick={prevPage}>
          <HiChevronLeft /> <span>Previous</span>
        </PaginationButton>

        <PaginationButton hide={currentPage === pageCount} onClick={nextPage}>
          <span>Next</span>
          <HiChevronRight />
        </PaginationButton>
      </Buttons>
